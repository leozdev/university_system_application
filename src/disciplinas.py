...
def alterar_dados_disciplina(db_disciplinas, sigla):
    ...
    Retorna: int: 1 se os dados foram alterados com sucesso, -1 se a alteração foi cancelada, 0 se a sigla não foi
    encontrada.
    """
    if sigla in db_disciplinas:
        dados = entrar_dados()
...
def remover_disciplina(db_disciplinas, sigla):
    ...
    Retorna: int: 1 se a disciplina foi removida com sucesso, -1 se a remoção foi cancelada, 0 se a disciplina não
    foi encontrada.
    """
    if sigla in db_disciplinas:
